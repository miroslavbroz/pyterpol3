...
project = 'Pyterpol'
copyright = '2016, Nemravova Jana'
author = 'Nemravova Jana'
...
latex_documents = [
    (master_doc, 'Pyterpol.tex', 'Pyterpol Documentation',
     'Nemravova Jana', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyterpol', 'Pyterpol Documentation',
     [author], 1)
]
